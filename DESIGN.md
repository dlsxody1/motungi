...
| Token | Hex | 용도 |
| --- | --- | --- |
| `primary` | `#d42f4a` | 메인 로즈 · 주요 CTA·강조·현재 선택 |
...
**M-030 재계산(2026-08-05):** 흰 텍스트 위 `primary` 조합(16px bold 버튼 — 18.66px bold 미만이라 "large text" 3:1 예외 미적용, WCAG AA 4.5:1 기준 적용)에서 구 값 `#e25067`은 WCAG 상대 휘도 공식 기준 대비 ≈3.77:1로 AA 미달. `#d42f4a`로 교체하여 대비 ≈4.88:1 확보(AA 통과). `primary-deep`(`#b0344e`, hover/press)은 흰 텍스트 대비 ≈6.09:1로 기존부터 AA 통과, 변경 없음.
